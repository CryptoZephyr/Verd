...
- Verd can record an authenticated release proof after repayment and release. The public evidence page separates the active facility's current state from the historical completed testnet record.
